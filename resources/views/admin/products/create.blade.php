                            ...
                            <div class="box-body">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group ">
                                        <img src="{{ asset('noimage.jpg') }}"  alt="User Image" id="preview" height="125px" width="125px" onchange="previewImage(this)">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="title" name="name" placeholder="product name" required="required" value="{{ old('name') }}">
                                    </div>

                                    <div class="form-group">
                                        <label for="title">Title<span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" id="title" name="title" placeholder="Title" required="required" value="{{ old('title') }}">
                                    </div>
