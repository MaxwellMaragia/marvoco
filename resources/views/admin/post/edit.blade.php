                                    ...
                                    <div class="row">
                                        <div class="container">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" class="form-control" id="title" name="title" placeholder="eg Market trends 2021" value="{{ $post->title }}" required="required">
                                            </div>
                                            <div class="col-md-6">
                                                <label for="name">Sub paragraph</label>
                                                <input type="text" class="form-control" id="header" name="subtitle" placeholder="eg Appears in homepage" value="{{ $post->subtitle }}" required="required">
                                            </div>
                                        ...
                                        <div class="container">
                                            <div class="col-md-12">
                                                ...
                                                <div class="form-group" style="margin-top: 20px;">
                                                    <img src="{{ Storage::url($post->image) }}"  alt="User Image" id="preview" height="120px" width="150px" onchange="previewImage(this)">
                                                </div>
