                        ...
                        <div class="box-body">
                            ...
                            <div class="col-md-offset-3 col-md-6">
                                ...
                                <div class="form-group">
                                    <div class="form-group">
                                        <img src="{{ Storage::url($logo->value) }}"  alt="User Image" id="preview"  onchange="previewImage(this)">
                                    </div>
                                    <div class="file">
                                        <label for="avatar" class="btn bg-navy btn-flat"><span class="fa fa-upload"></span> Upload  logo</label>
                                        <input type="file" name="logo" accept="image/*" class="form-control" id="darklogo">
                                    </div>
                                </div>
